...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_E4M3_M2] = { // fork-owned gguf-m2 dense plane; CPU path is a test reference only
        .from_float               = quantize_row_e4m3_m2,
        .vec_dot                  = ggml_vec_dot_e4m3_m2_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    ...
    [GGML_TYPE_NF8_M2] = { // fork-owned gguf-m2 dense plane (2nd encoding); CPU path is a test reference only
        .from_float               = quantize_row_nf8_m2,
        .vec_dot                  = ggml_vec_dot_nf8_m2_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q2_K] = {
