...
GGML_API void quantize_row_e4m3_m2_ref(const float * GGML_RESTRICT x, block_e4m3_m2 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_mxfp4_m2_ref(const float * GGML_RESTRICT x, block_mxfp4_m2 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_nf8_m2_ref(const float * GGML_RESTRICT x, block_nf8_m2 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_e4m3_m2(const block_e4m3_m2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_mxfp4_m2(const block_mxfp4_m2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_nf8_m2(const block_nf8_m2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_e4m3_m2(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_mxfp4_m2(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_nf8_m2(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
