...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    // ids [43, 89] are unallocated (upstream grows densely from 43; the
    // zero-initialized entries have blck_size == 0 and are rejected everywhere
    // a deprecated id is)
    [GGML_TYPE_E4M3_M2] = { // fork-owned gguf-m2 v1 dense plane (M2 Ultra target)
        .type_name                = "e4m3_m2",
        .blck_size                = QK_E4M3_M2,
        .type_size                = sizeof(block_e4m3_m2),
        .is_quantized             = true,
    ...
    [GGML_TYPE_NF8_M2] = { // fork-owned gguf-m2 dense plane, second encoding (M2 Ultra target)
        .type_name                = "nf8_m2",
        .blck_size                = QK_NF8_M2,
        .type_size                = sizeof(block_nf8_m2),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_nf8_m2,
        .from_float_ref           = (ggml_from_float_t) quantize_row_nf8_m2_ref,
    },
};
...
struct ggml_tensor * ggml_flash_attn_ext(
    ...
    if (mask) {
        ...
        GGML_ASSERT(ggml_is_contiguous_rows(mask));
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_NF8_M2:  result = quantize_nf8_m2 (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
