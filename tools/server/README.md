...
| `-ub, --ubatch-size N` | physical maximum batch size (default: 2048)<br/>(env: LLAMA_ARG_UBATCH) |
...
| `--spec-draft-n-max N` | number of tokens to draft for speculative decoding (default: 1)<br/>(env: LLAMA_ARG_SPEC_DRAFT_N_MAX) |
